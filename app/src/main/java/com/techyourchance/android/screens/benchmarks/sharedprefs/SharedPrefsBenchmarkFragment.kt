...
import com.techyourchance.android.benchmarks.sharedprefsedit.SharedPrefsEditBenchmarkUseCase
...
class SharedPrefsBenchmarkFragment : BaseFragment(), SharedPrefsBenchmarkViewMvc.Listener {
    ...
    @Inject lateinit var sharedPrefsEditBenchmarkUseCase: SharedPrefsEditBenchmarkUseCase
    ...
    private fun startBenchmark() {
        benchmarkJob = coroutineScope.launch {
            try {
                ...
                val result = sharedPrefsEditBenchmarkUseCase.runBenchmark()
